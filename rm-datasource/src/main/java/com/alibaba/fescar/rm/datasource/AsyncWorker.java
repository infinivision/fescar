...
public class AsyncWorker implements ResourceManagerInbound {
    ...
    private static class Phase2Context {
         ...
         */
        public Phase2Context(BranchType branchType, String xid, long branchId, String resourceId, String applicationData, BranchCommitResponse response, Consumer<AbstractMessage> asyncAction) {
            this.xid = xid;
        ...
        /**
         * The branch commit response
         */
        BranchCommitResponse response;
        /**
         * The commit branch async action
         */
    ...
    public void branchCommit(BranchType branchType, String xid, long branchId, String resourceId, String applicationData, BranchCommitResponse response, Consumer<AbstractMessage> asyncAction) throws TransactionException {
        if (ASYNC_COMMIT_BUFFER.size() < ASYNC_COMMIT_BUFFER_LIMIT) {
            ASYNC_COMMIT_BUFFER.add(new Phase2Context(branchType, xid, branchId, resourceId, applicationData, response, asyncAction));
        } else {
