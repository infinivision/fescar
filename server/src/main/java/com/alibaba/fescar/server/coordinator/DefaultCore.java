...
public class DefaultCore implements Core {
    ...
    @Override
    public void branchReport(String resourceId, BranchType branchType, String xid, long branchId, BranchStatus status, String applicationData) throws TransactionException {
