...
public interface ResourceManagerOutbound {
     ...
     * @throws TransactionException the transaction exception
     */
    void branchReport(String resourceId, BranchType branchType, String xid, long branchId, BranchStatus status, String applicationData) throws TransactionException;
