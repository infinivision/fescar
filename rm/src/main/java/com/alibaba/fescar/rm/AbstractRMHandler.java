...
public abstract class AbstractRMHandler extends AbstractExceptionHandler
     ...
     */
    protected void doBranchCommit(BranchCommitRequest request,
        BranchCommitResponse response, Consumer<AbstractMessage> asyncAction) throws TransactionException {
        String xid = request.getXid();
        long branchId = request.getBranchId();
        String resourceId = request.getResourceId();
        String applicationData = request.getApplicationData();
        response.setBranchStatus(BranchStatus.PhaseTwo_Committed);
        LOGGER.info("Branch committing: " + xid + " " + branchId + " " + resourceId + " " + applicationData);
        getResourceManager().branchCommit(request.getBranchType(), xid, branchId, resourceId, applicationData, response, asyncAction);
    }
     ...
     * @throws TransactionException the transaction exception
     */
    protected void doBranchRollback(BranchRollbackRequest request,
        BranchRollbackResponse response) throws TransactionException {
        String xid = request.getXid();
        long branchId = request.getBranchId();
        String resourceId = request.getResourceId();
