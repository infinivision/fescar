...
public class DefaultResourceManager implements ResourceManager {
	...
	@Override
	public void branchReport(String resourceId, BranchType branchType, String xid, long branchId, BranchStatus status,
			String applicationData) throws TransactionException {
		getResourceManager(branchType).branchReport(resourceId, branchType, xid, branchId, status, applicationData);
	}
